...
titulacion <- read_csv(file = "Documents/Ejercicio R/datos_titulacion (2).csv")
...
ggsave("Titulación_repositorio.jpeg",
       plot = grafica, width = 6, 
       height = 4, dpi = 500)#Para guardarlo en la carpeta de trabajo 
