...
#Se realiza una serie de experimentos 
#comparativos de cerebros de tres animales 
#destetados cuyas madres estuvieron expuestas 
#a una dieta restrictivas (desnutridas) y se 
#compararon con tres animales cuyas madres se 
#expusieron a una dieta ad libitum (eunutridas).
#Se desea saber: ¿Qué miRNAs fueron los que más 
#cambiaron entre los animales desnutridos 
#(tratamiento) comparados con los animales 
#eunutridos “control”?
...
grafica_dispersion2 <- grafica_dispersion+
  labs(title="Condición Contro vs Tratamiento",
       caption = "Creador: Marcelo Vergara",
